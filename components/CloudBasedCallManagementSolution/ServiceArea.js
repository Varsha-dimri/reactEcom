            ...
            <div className="col-6">
              <div className="col-1 "></div>
                  <div className="row py-2 ">
                      ...
                      <h4>Cloud based Call Management Solution will helps you to manage Communication with Customers</h4>
                      </div>
                      ...
                      <div className="container fluid">
                        <div className="row">      
                          <div className="col-lg-6">  
                            <h6 className="py-3"><strong>Grow your business with Cloud based Call Management Solution:</strong></h6><br />
