        ...
        <div className="features-area pt-80 pb-50 bg-f7fafd">
            ...
            <div className="container">
                <div className ="container-fluid">
                    <div className="row">
                        <div className="col-lg-3 col-md-3 col single-box pt-80"><br />
                            <div className="icon spinner-border-sm">
                                <Icon.Server /><br />
							</div>
                            <br />
                        ...
                        <div className="col-lg-3 col-md-3 col single-box"><br />
                            <div className="icon spinner-border-sm">
                                <Icon.Server /><br />
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 single-box"><br />
                            <div className="icon spinner-border-sm">
                                    <Icon.Server /><br />
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-ms-3 col single-box"><br />
                            <div className="icon spinner-border-sm">
                                    <Icon.Server /><br />
                                </div>
